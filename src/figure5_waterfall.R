...
# this script aims to generate a dataframe to replicate the Waterfall plot in Jen's Paper
...
CRISPRGeneEffect_23Q4 <- read_csv(here(
    "data/CRISPRGeneEffect_23Q4.csv"))

# Models file
Model_23Q4 <- read_csv(here("data/Model_23Q4.csv"))
